 ...
 *
 * ⚠️ **PAR OBRIGATÓRIO com `web/src/lib/formas-de-pagamento.ts`.** A tela
 ...
 *
 * Este lado é a AUTORIDADE: o que ele congela é o que vale, e o documento
 * gravado precisa ser reproduzível a partir dos próprios campos.
 */
