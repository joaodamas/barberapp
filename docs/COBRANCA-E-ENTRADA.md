...
```
    landing (cortehub.com.br)
        ↓  "Testar 7 dias"
    cria conta
        ↓
    escolhe o endereço  →  osiqueira.cortehub.com.br
        ↓
...
| | |
|---|---|
| **Conta Mercado Pago da CorteHub** | Access token de produção e chave pública. Não me mande por conversa — mesmo caminho do token da Meta |
| **CNPJ da CorteHub** | O Mercado Pago exige conta empresarial para assinatura recorrente, e a política de privacidade precisa nomear o controlador |
